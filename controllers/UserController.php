    ...
    case 'crear':
        case 'actualizar':
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $sucursal = intval($_POST['sucursal'] ?? 0) ?: null;
                $clave = $_POST['clave'] ?? '';
                ...
                $fotoNombre = null;
                if($id > 0){
                    // si es actualización, tomamos foto actual
                ...
                if($accion === 'crear'){
                    ...
                    $sql = "INSERT INTO usuarios (nombre, clave, rol, pregunta_seguridad, respuesta_seguridad_hash, foto, region, ciudad, municipio, sucursal) VALUES ('$nombre', '$claveHash', '$rol', '$pregunta_seguridad', " . ($respuesta_hash ? "'$respuesta_hash'" : "NULL") . ", " . ($fotoNombre ? "'$fotoNombre'" : "NULL") . ", " . ($region ?? "NULL") . ", " . ($ciudad ?? "NULL") . ", " . ($municipio ?? "NULL") . ", " . ($sucursal ?? "NULL") . ")";
