...
function catDesdeEquipo($nomEquipo) {
  ...
  $alarmaKeys = ["ALARMA","TRANSMISOR","SENSOR","DETECTOR","HUMO","OVER HEAD","OVERHEAD","ZONA","BOTON","BOTON PANICO","PANICO","ESTACION","PULL STATION","PULL","PANEL","CABLEADO","SIRENA","RECEPTOR","EMISOR","LLAVIN","TECLADO","ESTROBO","CRISTAL","RUPTURA","REPETIDOR","REPETIDORA","DH","PIR","CM","BTN","OH","DRC","REP"];
...
<style>
  ...
  h1,h2,h3 { margin: 0; }
  .topband {width:100%;background: #0a2128;color:#e6f2f4;padding:10px 14px;border-radius:6px;margin-bottom:10px;}
  ...
  .section {margin-top: 14px;border: 1px solid #cfd8dc;border-radius: 6px;overflow: hidden;}
  .section .section-header {background: #e9f5f8;padding: 8px 10px;font-weight: 700;color:#0a2128;border-bottom:1px solid #cfd8dc;}
  .section .section-body { padding: 8px 8px 2px 8px; }
  .badge {display:inline-block; padding:2px 6px; border-radius:4px;background:#e9f5f8; border:1px solid #cce8ee; font-weight:bold;}
...
<div class="topband">
  ...
  <div class="meta">Ubicación: <?= safe($device['nom_ciudad']) ?>, <?= safe($device['nom_municipio']) ?>, <?= safe($device['nom_sucursal']) ?></div>
</div>
<table class="logos">
  <tr>
