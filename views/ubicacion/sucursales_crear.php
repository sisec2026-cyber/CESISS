...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    <p class="mb-0">
      Selecciona <strong>Ciudad</strong> y <strong>Municipio</strong>, escribe el <strong>nombre de la sucursal</strong>, su <strong>determinante</strong>, y captura <strong>sus cordenadas</strong> con el mapa (o búsqueda).
    </p>
  </div>
</div>
...
<div class="col-md-3">
  ...
  <input type="text" class="form-control" name="lat" id="lat"
         inputmode="decimal" pattern="-?[0-9]*[.,]?[0-9]*" autocomplete="off" required>
</div>
<div class="col-md-3">
