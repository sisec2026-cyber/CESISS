...
<head>
  <meta charset="UTF-8" />
  <title>CESISS - <?= htmlspecialchars($pageTitle ?? 'Inicio') ?></title>
  ...
  <style>
    :root{
      --sidebar-w: 280px;     /* ajusta si tu sidebar mide diferente */
    ...
    @media (min-width: 992px) {
      html, body { padding-right: 10px !important; }
    }
    ...
    @media (max-width: 991.98px) {
      ...
      @media (max-width: 991px) {
        .topbar {
          padding-left: 60px; /* deja espacio para el botón del menú */
        }
      }
      @media (max-width: 991px) {
        .btn.d-lg-none {
...
<body class="has-fixed-topbar">
  ...
  <?php endif; ?>
  <?php include __DIR__ . '/includes/help-widget.html'; ?>
</body>
</html>